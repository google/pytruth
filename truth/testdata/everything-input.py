...
self.assertEqual(equal_ea, frozenset())
self.assertEqual(equal_eb, list())
self.assertEqual(equal_ec, set())
self.assertEqual(equal_ed, tuple())
self.assertEqual(equal_ee, collections.OrderedDict())
self.assertEqual('', equal_ef)
self.assertEqual("", equal_eg)
self.assertEqual(r'', equal_eh)
self.assertEqual(r"", equal_ei)
self.assertEqual(u'', equal_ej)
self.assertEqual(u"", equal_ek)
self.assertEqual((), equal_el)
self.assertEqual([], equal_em)
self.assertEqual({}, equal_en)
self.assertEqual(dict(), equal_eo)
self.assertEqual(frozenset(), equal_ep)
self.assertEqual(list(), equal_eq)
self.assertEqual(set(), equal_er)
self.assertEqual(tuple(), equal_es)
self.assertEqual(collections.OrderedDict(), equal_et)
...
self.assertLen(equal_len_a0, equal_len_b0)
self.assertLen(equal_len_a1, 103)
self.assertLen(equal_len_a2, 0)

self.assertEmpty(empty_container_a0)

self.assertNotEmpty(not_empty_container_a0)
...
self.assertNotEqual(not_equal_ea, frozenset())
self.assertNotEqual(not_equal_eb, list())
self.assertNotEqual(not_equal_ec, set())
self.assertNotEqual(not_equal_ed, tuple())
self.assertNotEqual(not_equal_ee, collections.OrderedDict())
self.assertNotEqual('', not_equal_ef)
self.assertNotEqual("", not_equal_eg)
self.assertNotEqual(r'', not_equal_eh)
self.assertNotEqual(r"", not_equal_ei)
self.assertNotEqual(u'', not_equal_ej)
self.assertNotEqual(u"", not_equal_ek)
self.assertNotEqual((), not_equal_el)
self.assertNotEqual([], not_equal_em)
self.assertNotEqual({}, not_equal_en)
self.assertNotEqual(dict(), not_equal_eo)
self.assertNotEqual(frozenset(), not_equal_ep)
self.assertNotEqual(list(), not_equal_eq)
self.assertNotEqual(set(), not_equal_er)
self.assertNotEqual(tuple(), not_equal_es)
self.assertNotEqual(collections.OrderedDict(), not_equal_et)
